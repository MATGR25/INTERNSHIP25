# This script has been improved to use a fine-tuned FaceNet model's weights.
...
# --- Configuration ---
# Use the same file paths from your training script
FINETUNED_WEIGHTS_PATH = "./finetuned_facenet_weights.weights.h5"
...
try:
    print("Loading FaceNet embedder architecture...")
    facenet_embedder = FaceNet()
    # Now, attempt to load the fine-tuned weights
    if os.path.exists(FINETUNED_WEIGHTS_PATH):
        print(f"Loading fine-tuned weights from {FINETUNED_WEIGHTS_PATH}...")
        facenet_embedder.model.load_weights(FINETUNED_WEIGHTS_PATH)
        print("Fine-tuned weights loaded successfully!")
    else:
        print("Fine-tuned weights file not found. Using default pre-trained model.")
